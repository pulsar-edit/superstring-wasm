...
describe('TextBuffer', () => {
  ...
  describe('.find (sync and async)', () => {
    ...
    it('can be called repeatedly with the same RegExp to avoid recompiling the RegExp', async function () {
      this.timeout(9000)
      const buffer = new TextBuffer('abc\ndef')
  ...
  describe('.findAll (sync and async)', () => {
    ...
    it('can be called repeatedly between buffer mutations without harming performance', async function() {
      this.timeout(9000)
